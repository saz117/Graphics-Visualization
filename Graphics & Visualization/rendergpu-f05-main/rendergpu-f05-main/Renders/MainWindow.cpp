    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(this->ui->action_obre_animation, SIGNAL(triggered()), builder, SLOT(newVirtualAnimation()));
...
void MainWindow::on_browseTextureBtn_pressed()
{
    ...
    //Añadido para que se actualice automaticamente una vez cargada la nueva textura
    glWidget->updateGL();
}
